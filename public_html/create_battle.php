...
<head>
  ...
  <script src="create_battle.js" defer></script>
</head>
<body class="with-side-nav create-roulette create-battle">
  <?php include 'nav.php'; ?>
    ...
    <form id="cb-form" autocomplete="off">
      ...
      <section class="step-panel" data-step="1">
        <div class="field field-cover">
          ...
          <input id="cb-name" name="name" type="text" maxlength="100" required placeholder="My battle" />
        </div>
        ...
        <div class="field">
          <label for="cb-cover">Or</label>
          <div class="field-inline">
            <input id="cb-cover" name="cover" type="text" placeholder="https://..." />
      ...
      <section class="step-panel" data-step="2">
        ...
        <section class="source-block">
          <div class="source-header">
            <h3>Rating</h3>
            <div class="source-actions">
              <button type="button" class="btn small text-reset" id="ratings-reset">Reset</button>
              <button type="button" class="btn small" id="ratings-select-all">Select all</button>
            </div>
          </div>
          <span class="muted">Optional: Unselect rating</span>
          <div id="rating-chips" class="chips" aria-live="polite"></div>
        </section>
        ...
        <section class="source-block">
          ...
          <span class="muted">Optional: Select if recommeded only</span>
          <div class="chips">
      ...
      <div class="actions">
        ...
        <a class="btn-cancel" href="battles.php">Cancel</a>
      ...
      <div id="cb-message" class="status"></div>
    </form>
  </main>
</body>
</html>
